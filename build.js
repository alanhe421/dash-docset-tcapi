...
function crawlSite(site) {
  ...
  childProcess.execSync(`wget -nc -np --compression=gzip --domains=cloud.tencent.com -e robots=off -P ./source-html --adjust-extension -r '${site}' --no-parent`, {stdio: 'inherit'});
}
